...
int main (int argc, const char *argv[])
{
    ...
    while ( (c = getopt(argc, (char **)argv, "vb:")) != -1 ) {
        switch ( c ) {
...
#if TIMERSOURCE
    error = KEXTDStartMain(kextd, beVerbose, enableTimer, period, bootlevel);
#else
    error = KEXTDStartMain(kextd, beVerbose, bootlevel);
#endif
