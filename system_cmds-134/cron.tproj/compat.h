...
/*
 * $Id: compat.h,v 1.1.1.2 2000/01/11 02:10:08 wsanchez Exp $
 */
...
# define NEED_VFORK
	...
	!defined(IRIX) && !defined(__APPLE__) && !defined(HPUX)
...
#if (!defined(BSD) || (BSD < 198911)) && !defined(POSIX) && !defined(__APPLE__)
