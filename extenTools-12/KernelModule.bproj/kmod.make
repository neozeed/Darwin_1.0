...
IOKIT_FRAMEWORK = $(SYSTEM_LIBRARY_DIR)/Frameworks/IOKit.framework
KINCVERS = A
...
PROJTYPE_LDFLAGS = -r -static -L$(IOKIT_FRAMEWORK)/Resources
...
$(PRODUCT): $(DEPENDENCIES)
	...
	cmd="$(LD) -o $(PRODUCT) -nostdlib $(ALL_LDFLAGS) $(ARCHITECTURE_FLAGS)\
	    $$non_info -lkmodc++ $(KMOD_INFO_OFILE) -lkmod -lcc"; \
	$(ECHO) $$cmd; eval "$$cmd"
