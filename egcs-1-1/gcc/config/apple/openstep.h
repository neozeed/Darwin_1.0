...
#elif defined (MACOSX) && 0
#  undef  OLD_GPLUSPLUS_INCLUDE_DIR
#  define OLD_GPLUSPLUS_INCLUDE_DIR \
	"/System/Library/Frameworks/System.framework/Headers/g++"
...
#undef	HANDLE_PRAGMA
#define HANDLE_PRAGMA(finput, word) handle_pragma (finput, word)
