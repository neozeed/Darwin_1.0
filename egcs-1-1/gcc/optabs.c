...
/* NEXT_LIBGCC_NAMES means there's only one underscore prefix, but many
   names defined here have two such underscores.  So toss one of them. */
#define gen_rtx_LIBGCC_SYM(mode, name)	gen_rtx_SYMBOL_REF (mode, (name)+1)
#else
#define gen_rtx_LIBGCC_SYM(mode, name)	gen_rtx_SYMBOL_REF (mode, name)
#endif

  extendsfdf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__extendsfdf2");
  extendsfxf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__extendsfxf2");
  extendsftf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__extendsftf2");
  extenddfxf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__extenddfxf2");
  extenddftf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__extenddftf2");

  truncdfsf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__truncdfsf2");
  truncxfsf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__truncxfsf2");
  trunctfsf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__trunctfsf2");
  truncxfdf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__truncxfdf2");
  trunctfdf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__trunctfdf2");
  ...
  bcmp_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__gcc_bcmp");
  ...
  eqsf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__eqsf2");
  nesf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__nesf2");
  gtsf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__gtsf2");
  gesf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__gesf2");
  ltsf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__ltsf2");
  lesf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__lesf2");

  eqdf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__eqdf2");
  nedf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__nedf2");
  gtdf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__gtdf2");
  gedf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__gedf2");
  ltdf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__ltdf2");
  ledf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__ledf2");

  eqxf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__eqxf2");
  nexf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__nexf2");
  gtxf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__gtxf2");
  gexf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__gexf2");
  ltxf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__ltxf2");
  lexf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__lexf2");

  eqtf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__eqtf2");
  netf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__netf2");
  gttf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__gttf2");
  getf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__getf2");
  lttf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__lttf2");
  letf2_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__letf2");

  floatsisf_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__floatsisf");
  floatdisf_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__floatdisf");
  floattisf_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__floattisf");

  floatsidf_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__floatsidf");
  floatdidf_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__floatdidf");
  floattidf_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__floattidf");

  floatsixf_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__floatsixf");
  floatdixf_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__floatdixf");
  floattixf_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__floattixf");

  floatsitf_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__floatsitf");
  floatditf_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__floatditf");
  floattitf_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__floattitf");

  fixsfsi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixsfsi");
  fixsfdi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixsfdi");
  fixsfti_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixsfti");

  fixdfsi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixdfsi");
  fixdfdi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixdfdi");
  fixdfti_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixdfti");

  fixxfsi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixxfsi");
  fixxfdi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixxfdi");
  fixxfti_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixxfti");

  fixtfsi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixtfsi");
  fixtfdi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixtfdi");
  fixtfti_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixtfti");

  fixunssfsi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixunssfsi");
  fixunssfdi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixunssfdi");
  fixunssfti_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixunssfti");

  fixunsdfsi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixunsdfsi");
  fixunsdfdi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixunsdfdi");
  fixunsdfti_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixunsdfti");

  fixunsxfsi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixunsxfsi");
  fixunsxfdi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixunsxfdi");
  fixunsxfti_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixunsxfti");

  fixunstfsi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixunstfsi");
  fixunstfdi_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixunstfdi");
  fixunstfti_libfunc = gen_rtx_LIBGCC_SYM (Pmode, "__fixunstfti");
