...
extern debug_log_dps_call(const char *);
...
Lisp_Object on, display;
   {
   check_ns();
   debug_log_dps_call("ns-synchronize (DPSSetWrapSynchronization)");
...
Lisp_Object flag;
   {
   check_ns();
   debug_log_dps_call("ns-show-ps: [NSDPSContext setAllContextsOutputTraced]");
...
Lisp_Object flag;
   {
   check_ns();
   debug_log_dps_call("ns-show-event: [NSDPSServerContext setEventsTraced]");
