...
install-sendmail: sendmail
	...
	${INSTALL} -c -o ${BINOWN} -g ${BINGRP} -m ${BINMODE} sendmail ${DESTDIR}${BINDIR}
	${INSTALL} -d -m 755 ${DESTDIR}${UBINDIR}
	for i in ${LINKS}; do rm -f ${DESTDIR}$$i; ln -s ${BINDIR}/sendmail ${DESTDIR}$$i; done
	${INSTALL} -d -m 755 ${DESTDIR}${HFDIR}
	${INSTALL} -c -o ${BINOWN} -g ${BINGRP} -m 444 sendmail.hf \
	    ${DESTDIR}${HFDIR}/sendmail.hf
	${INSTALL} -d -m 755 ${DESTDIR}${STDIR}
	${INSTALL} -c -o ${BINOWN} -g ${BINGRP} -m 644 sendmail.st \
	    ${DESTDIR}${STDIR}/sendmail.st
