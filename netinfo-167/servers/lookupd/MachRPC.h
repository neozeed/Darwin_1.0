...
#define PROC_CHECKSECURITYOPT 41
#define PROC_CHECKNETWAREENBL 42
#define PROC_SETLOGINUSER 43
#define PROC__GETSTATISTICS 44
#define PROC__INVALIDATECACHE 45
#define PROC__SUSPEND 46
