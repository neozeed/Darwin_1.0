/* $Header: /cvs/Darwin/Services/bind/bind/contrib/dns_signer/signer/signer_sign.c,v 1.1.1.1 1999/10/04 22:25:52 wsanchez Exp $ */
		...
		for (a_sig = a_set->rrs_sig; a_sig; a_sig = a_sig->rr_next)
		{
			...
			*/
			...
			if (a_sig->rr_rdata[SIG_RDATA_ALGORITHM] == (u_int8_t) alg_number)
			{
				...
				struct name_rec		*signer;
				struct rrset_rec	*signers_keys;
				struct rr_rec		*the_key;
