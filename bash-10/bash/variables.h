 ...
 * work.  Therefore, if the compiler or system headers give us
 * the machine type, we should trust it over configure, which
 * tells us the host architecture, and not the target
 * architecture(s).
 **/
