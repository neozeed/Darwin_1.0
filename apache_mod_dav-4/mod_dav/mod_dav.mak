...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /GX /O2 /I "\apache-1.3\src\include" /I "\apache-1.3\src\lib\expat-lite" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "SHARED_MODULE" /Fp"$(INTDIR)\mod_dav.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
CPP=cl.exe
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /ZI /Od /I "\apache-1.3\src\include" /I "\apache-1.3\src\lib\expat-lite" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "SHARED_MODULE" /Fp"$(INTDIR)\mod_dav.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib wsock32.lib \apache-1.3\src\cored\apachecore.lib sdbm\debug\sdbm.lib \apache-1.3\src\lib\expat-lite\Debug\xmlparse.lib \apache-1.3\src\lib\expat-lite\Debug\xmltok.lib /nologo /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\mod_dav.pdb" /debug /machine:I386 /out:"$(OUTDIR)\mod_dav.dll" /implib:"$(OUTDIR)\mod_dav.lib" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\dav_fs_dbm.obj" \
	"$(INTDIR)\dav_fs_lock.obj" \
	"$(INTDIR)\dav_fs_repos.obj" \
