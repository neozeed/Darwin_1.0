...
static id _internal_object_copyFromZone(Object *anObject, unsigned nBytes, NXZone *zone) 
{
	id obj;
...
static id _internal_object_reallocFromZone(Object *anObject, unsigned nBytes, NXZone *zone) 
{
	Object *newObject; 
	Class tmp;
