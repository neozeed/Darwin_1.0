...
symbol_file_add PARAMS ((const char *, int, struct section_addr_info *, int, int, CORE_ADDR, const char *));
 
extern struct objfile *
symbol_file_add_bfd PARAMS ((bfd *, int, struct section_addr_info *, int, int, CORE_ADDR, const char *));
