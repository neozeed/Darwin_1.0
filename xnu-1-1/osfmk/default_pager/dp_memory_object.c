	...
	vm_prot_t		protection_required)
{
	...
	pvs_cluster_read(vs, offset, length);
	...
	vm_size_t		data_cnt)
{
	 ...
	 * boundaries.
	 */
	vs_cluster_write(vs, offset, addr, data_cnt, FALSE);
	...
	boolean_t		kernel_copy)
{
	...
	if(!VS_TRY_LOCK(vs)) {
		...
		upl_system_list_request((vm_object_t)
                                ...
                                offset, data_cnt, data_cnt, &page_list, NULL, 0,
...
kern_return_t
dp_memory_object_discard_request(
	memory_object_t		mem_obj, 
