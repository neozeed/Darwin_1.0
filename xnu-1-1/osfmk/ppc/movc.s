...
wegotaltivec:
			...
			dstt	r3,r6,3						; Stream in the page
...
/* Set up thread_recover in case we hit an illegal address */
		...
		lwz		r8,VMMAP_PMAP(r8)
		rlwimi	r7,r4,24,8,11 					/* Insert seg number */
		subi	r9,r9,1							/* Make sure we don't go too far */
		stw		r11,THREAD_RECOVER(r10)
 ...
 */
		...
		addis	r7,r7,0x0010					/* Yeah, we did, so bump the segment */
		b		nxtseg							/* Keep going... */
