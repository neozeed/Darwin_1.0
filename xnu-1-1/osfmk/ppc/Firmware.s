...
ENTRY(LLTraceSet, TAG_NO_FRAME_USED)
			...
			andi.	r11,r12,0x01C0					/* Clear interrupts and translation */
			mtmsr	r11								/* Set 'em all off */
			isync
			
			lwz		r3,0x180(br0)					/* Get the old trace flags to pass back */
			stw		r4,0x180(br0)					/* Replace with the new ones */
...
LEXT(stVectors)
			...
			rlwinm	r6,r6,16,16,31		; Rotate on it
			li		r3,0				; Assume failure
			cmplwi	r6,PROCESSOR_VERSION_Max	; Do we have Altivec?
			bltlr+						; No...
