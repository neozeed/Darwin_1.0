...
OSDefineMetaClassAndStructors(IOSCSIHDDriveNub,IOHDDriveNub)
...
{
    return(_provider->doAsyncReadWrite(buffer,block,nblks,action,target,param));
}
...
IOReturn
IOSCSIHDDriveNub::executeCdb(struct cdbParams *params)
{
