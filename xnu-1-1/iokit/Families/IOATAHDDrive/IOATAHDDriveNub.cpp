...
OSDefineMetaClassAndStructors( IOATAHDDriveNub, IOHDDriveNub )
...
IOReturn IOATAHDDriveNub::executeCdb(struct cdbParams *params)
{
    return(kIOReturnUnsupported);		// n/a for ATA; no cdb concept
}
