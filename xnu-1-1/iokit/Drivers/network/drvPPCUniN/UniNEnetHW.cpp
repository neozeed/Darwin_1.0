...
void WriteUniNRegister( IOPPCAddress ioBaseEnet, u_int32_t reg_offset, u_int32_t data )
{
    switch ( reg_offset >> 16 )
    {
        case 1:
            ...
            break;
        case 2:
            ((u_int16_t *)ioBaseEnet)[(reg_offset & 0xFFFF) >> 1] = EndianSwap16( data );
            break; 
        case 4:
            ((u_int32_t *)ioBaseEnet)[(reg_offset & 0xFFFF) >> 2] = EndianSwap32( data );
            break; 
    }
    eieio();
}
...
volatile u_int32_t ReadUniNRegister( IOPPCAddress ioBaseEnet, u_int32_t reg_offset )
{
    switch ( reg_offset >> 16 )
    {
        case 1:
        ...
        case 2:
            return EndianSwap16( ((u_int16_t *)ioBaseEnet)[(reg_offset & 0xFFFF) >> 1] );
 
        case 4:
            return EndianSwap32( ((u_int32_t *)ioBaseEnet)[(reg_offset & 0xFFFF) >> 2] );
    }
