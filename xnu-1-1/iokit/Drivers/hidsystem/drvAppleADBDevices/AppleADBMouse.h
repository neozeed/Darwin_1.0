...
#define kSoftClick		"Clicking"
#define k15Press		"Dragging"
#define kStickyDrag		"DragLock"
...
public:
  ...
  virtual void accelerationTable(IOHIAccelerationPoint ** table, IOItemCount * numEntries);
...
private:
    bool Clicking, Dragging, DragLock;
