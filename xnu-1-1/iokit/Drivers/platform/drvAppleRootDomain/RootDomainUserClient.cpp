...
bool RootDomainUserClient::start( IOService * provider )
{
    ...
    fMethods[kPMSetAggressiveness].object = provider;
    ...
    fMethods[kPMGetAggressiveness].object = provider;
    ...
    fMethods[kPMSleepSystem].object = provider;
    ...
    fMethods[kPMWakeSystem].object = provider;
    fMethods[kPMWakeSystem].func = (IOMethod)&IOPMrootDomain::wakeSystem;
    fMethods[kPMWakeSystem].count0 = 0;
    fMethods[kPMWakeSystem].count1 = 0;
    fMethods[kPMWakeSystem].flags = kIOUCScalarIScalarO;
