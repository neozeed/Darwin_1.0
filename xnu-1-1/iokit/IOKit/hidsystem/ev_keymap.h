...
#define	NX_KEYTYPE_MUTE			7	/* Processed by kernel */
#define NX_UP_ARROW_KEY			8	/* Processed by kernel */
#define NX_DOWN_ARROW_KEY		9
#define	NX_NUMSPECIALKEYS		10 /* Maximum number of special keys */
#define NX_NUM_SCANNED_SPECIALKEYS	8 /* First 8 special keys are */
