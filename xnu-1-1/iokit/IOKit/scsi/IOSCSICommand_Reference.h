...
Note: The exact subset of return codes a SCSI command will return is
currently under review.
@field bytesTransferred
The total number of bytes transferred to/from the target device.
@field adapterStatus
This field provides additional adapter reported error information. The SCSI
Family uses this information to determine whether the target rejected a
negotiation attempt (either/or) wide or synchronous.
@field scsiStatus
...
@param isSense
If isSense is set to true, the IOSCSICommand's data buffer information is set. Otherwise,
