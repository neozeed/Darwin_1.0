...
/*!
    @class OSOrderedSet
    @abstract A collection class for maintaining and sorting a set of OSObject derived objects.
    @discussion
    An instance of OSOrderedSet maintains and sorts a collection of OSObject derived objects.  The sorting algorithm is supplied to the instance via the OSOrderFunction.
*/
...
public:
    /*!
        ...
        @param ref The ordering conext used by the sorting function as a hint for sorting.
     ...
     */
    typedef SInt32 (*OSOrderFunction)( OSObject * obj1, OSObject * obj2, void * ref );
...
public:
    ...
    */
    ...
    /*!
        ...
        @param anObject The OSObject derived object to be compared against the receiver.
        @result Returns true if the two objects are equivalent, false otherwise.
    */
