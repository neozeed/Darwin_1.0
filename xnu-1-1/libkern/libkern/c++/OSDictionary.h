...
public:
    ...
    */
    ...
    /*!
        ...
        @param objects A static array of OSObject derived objects.
    ...
    */
    ...
    /*!
        ...
        @param objects A static array of OSObject derived objects to be placed into the dictionary.
        @param keys A static array of OSSymbol keys which identify the correspoding objects provided in the 'objects' parameter.
    ...
    */
    ...
    /*!
        ...
        @abstract A member function to initialize an instance of OSDictionary and populate it with the provided objects and keys.
        @param objects A static array of OSObject derived objects to be placed into the dictionary.
        @param keys A static array of OSString keys which identify the correspoding objects provided in the 'objects' parameter.
        @param count The number of objects provided to the dictionary.
        @param capacity The initial storage capacity of the dictionary object.  If 0, the capacity will be set to the size of 'count', else the capacity must be greater than or equal to the value of 'count'.
        @result Returns true if intialization succeeded or false on failure.
    */
    ...
    /*!
        ...
        @param dict The dictionary contining the objects to be used to populate the receiving dictionary.
    ...
    */
    ...
    /*!
        ...
        @param keys An OSArray or OSDictionary containing the keys describing the intersecion for the comparison.
