...
bool OSSet::initWithObjects(OSObject *inObjects[],
                          ...
                          unsigned int inCapacity = 0)
{
    ...
    return initWithObjects(inArray->array, inArray->count,
                           inCapacity);
}
...
OSSet *OSSet::withObjects(OSObject *objects[],
                          unsigned int count,
...
bool OSSet::setObject(OSObject *anObject)
{
...
void OSSet::removeObject(OSObject *anObject)
{
...
bool OSSet::containsObject(const OSObject *anObject) const
{
    return anObject && member(anObject);
}

bool OSSet::member(const OSObject *anObject) const
{
    OSObject *probeObject;
...
bool OSSet::isEqualTo(OSSet *aSet) const
{
    unsigned int count;
    unsigned int i;
    OSObject *obj1;
...
bool OSSet::isEqualTo(const OSObject *anObject) const
{
    OSSet *otherSet;

    otherSet = OSDynamicCast(OSSet, (OSObject *)anObject);
    if ( otherSet )
