...
*/
#define DDP_CHKSUM_ON	1	/* DDP checksums should be used */
  /* *** DDP_CHKSUM_ON not yet fully implemented *** */
#define DDP_HDRINCL	2	/* int; header is included with data */
#define DDP_GETSOCKNAME	3	/* used to get ddp_addr_t */
#define DDP_SLFSNDOFF	4	/* packets sent to the cable-multicast address
				   on this socket should not be looped back */
  /* *** DDP_SLFSNDOFF not yet fully implemented *** */
#define DDP_STRIPHDR	5	/* drop DDP header on receive (raw) */
...
/* 
   Basic NBP Definitions needed for LibcAT 
*/
