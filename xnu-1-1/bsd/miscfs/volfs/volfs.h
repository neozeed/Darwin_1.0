...
/* Flag set for HFS volumes to indicate roman-only encoding: */
#define VOLFS_ROMANONLY  0x40000000

/* Summary of all flags in volume id's exported to outside view: */
#define VOLFS_VOLIDFLAGS (VOLFS_ROMANONLY)
